export const PRIVACY_HTML_2026_01 = `
<div style="max-width:780px; margin:0 auto; padding:clamp(40px,7vw,72px) clamp(20px,5vw,32px) clamp(60px,9vw,96px); color:#33232A;">
  ...
  <h1 style="font-family:'Noto Serif KR',serif; font-size:clamp(23px,5vw,30px); font-weight:600; letter-spacing:-0.02em; margin:14px 0 8px; line-height:1.45;">개인정보처리방침</h1>
  ...
  <div style="background:#FAF3F5; border-radius:4px; padding:22px 24px; margin:0 0 34px;">
    ...
    <ol style="font-size:13.5px; line-height:1.95; color:#6B5A60; margin:0; padding-left:20px;">
      <li>개인정보의 처리 목적</li>
      <li>개인정보의 처리 및 보유 기간</li>
      <li>처리하는 개인정보의 항목 및 수집 방법</li>
      <li>하객의 개인정보 처리에 관한 사항</li>
      <li>영상 촬영에 관한 사항</li>
      <li>만 14세 미만 아동의 개인정보 처리에 관한 사항</li>
      <li>개인정보의 제3자 제공에 관한 사항</li>
      <li>개인정보 처리업무의 위탁에 관한 사항</li>
      <li>개인정보의 파기절차 및 파기방법</li>
      <li>정보주체와 법정대리인의 권리·의무 및 그 행사방법</li>
      <li>개인정보의 안전성 확보조치</li>
      <li>개인정보를 자동으로 수집하는 장치의 설치·운영 및 거부</li>
      <li>개인정보 보호책임자</li>
  ...
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 14px;">(1) 회사는 개인정보를 수집할 때 동의받은 보유·이용기간 내에서 개인정보를 처리·보유합니다. 처리목적이 달성되거나 정보주체의 삭제 요청이 있는 경우 지체 없이 파기합니다. 항목별 보유기간은 다음과 같습니다.</p>
  <div style="overflow-x:auto; margin:0 0 14px;">
    <table style="width:100%; border-collapse:collapse; font-size:13.5px; min-width:440px;">
      <thead>
        <tr>
          <th style="text-align:left; padding:11px 14px; background:#FAF3F5; color:#6B5A60; font-weight:500; border-bottom:1px solid #EBDCE0;">구분</th>
          <th style="text-align:left; padding:11px 14px; background:#FAF3F5; color:#6B5A60; font-weight:500; border-bottom:1px solid #EBDCE0;">보유 기간</th>
        </tr>
      </thead>
      <tbody>
  ...
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(2) 제1항에도 불구하고 해당 예식에 관한 분쟁이 제기되어 진행 중인 경우, 회사는 그 분쟁이 종료될 때까지 관련 개인정보 및 영상을 보관할 수 있습니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 14px;">(3) 관계 법령의 규정에 의하여 보존할 필요가 있는 경우, 회사는 아래와 같이 법령이 정한 기간 동안 관련 정보를 보관합니다.</p>
  <div style="overflow-x:auto; margin:0 0 14px;">
  ...
  <div style="overflow-x:auto; margin:0 0 14px;">
    <table style="width:100%; border-collapse:collapse; font-size:13.5px; min-width:520px;">
      <thead>
        <tr>
          <th style="text-align:left; padding:11px 14px; background:#FAF3F5; color:#6B5A60; font-weight:500; border-bottom:1px solid #EBDCE0;">구분</th>
          <th style="text-align:left; padding:11px 14px; background:#FAF3F5; color:#6B5A60; font-weight:500; border-bottom:1px solid #EBDCE0;">필수 항목</th>
          <th style="text-align:left; padding:11px 14px; background:#FAF3F5; color:#6B5A60; font-weight:500; border-bottom:1px solid #EBDCE0;">선택 항목</th>
        </tr>
      </thead>
      <tbody>
  ...
  <h2 style="font-family:'Noto Serif KR',serif; font-size:17px; font-weight:600; margin:40px 0 12px; padding-top:28px; border-top:1px solid #EBDCE0;">4. 하객의 개인정보 처리에 관한 사항</h2>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(1) 회사는 축의금 접수 과정에서 하객의 성명 및 봉투 고유번호를 기록합니다. 이는 접수된 봉투의 매수를 대조하고 정산 리포트를 작성하기 위한 최소한의 항목이며, 회사는 봉투를 개봉하지 아니하므로 하객이 낸 금액은 수집하지 아니합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(2) 회사는 접수대에 개인정보 수집 사실을 알리는 고지문을 게시하여, 하객이 접수 전에 이를 확인할 수 있도록 합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(3) 하객이 성명 기재를 원하지 아니하는 경우, 회사는 봉투 고유번호만으로 접수를 진행합니다. 성명 기재는 하객의 임의 선택 사항입니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(4) 회사는 기록한 하객의 성명 및 봉투 고유번호를 정산 리포트의 형태로 의뢰인에게 인계하며, 인계 이후 회사가 보관하는 사본은 예식일로부터 30일 이내에 파기합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(5) 회사는 하객의 개인정보를 마케팅, 광고, 통계 작성 등 정산·인계 이외의 목적으로 이용하지 아니하며, 제3자에게 제공하지 아니합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(6) 매니저가 업무 수행을 위해 개인 기기에 저장한 기록 사본은 업무 종료 후 지체 없이 파기하며, 회사는 이를 확인·관리합니다.</p>

  <h2 style="font-family:'Noto Serif KR',serif; font-size:17px; font-weight:600; margin:40px 0 12px; padding-top:28px; border-top:1px solid #EBDCE0;">5. 영상 촬영에 관한 사항</h2>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(1) 회사는 접수·인계 과정의 기록 및 분쟁 예방을 목적으로 축의대 운영 구역을 촬영합니다. 촬영 범위는 접수대 운영 구역으로 한정하며, 하객 개인을 특정하여 촬영하지 아니합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(2) 회사는 「개인정보 보호법」 제25조의2에 따라 촬영 사실을 접수대의 안내판으로 표시하여 정보주체가 이를 알 수 있도록 합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(3) 촬영된 영상은 제한된 링크 등의 방식으로 의뢰인에게만 제공되며, 회사는 이를 외부에 유출·게시하지 아니합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(4) 영상의 보관 기간은 예식일로부터 30일로 하며, 기간 경과 후 지체 없이 파기합니다. 다만 해당 예식에 관한 분쟁이 진행 중인 경우에는 그 분쟁이 종료될 때까지 보관할 수 있습니다.</p>
  ...
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(2) 회사는 현재 개인정보를 제3자에게 제공하지 아니합니다. 향후 제공이 필요하게 되는 경우, 제공받는 자·제공 목적·제공 항목·보유 및 이용 기간을 사전에 알리고 동의를 받은 후 본 방침을 통해 공개합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(3) 회사는 정부 관계부처가 합동으로 발표한 「긴급상황 시 개인정보 처리 및 보호수칙」에 따라 재난, 감염병, 급박한 생명·신체 위험을 초래하는 사건·사고 등 긴급상황이 발생하는 경우, 정보주체의 동의 없이 관계기관에 개인정보를 제공할 수 있습니다.</p>

  <h2 style="font-family:'Noto Serif KR',serif; font-size:17px; font-weight:600; margin:40px 0 12px; padding-top:28px; border-top:1px solid #EBDCE0;">8. 개인정보 처리업무의 위탁에 관한 사항</h2>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 14px;">(1) 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.</p>
  <div style="overflow-x:auto; margin:0 0 14px;">
    <table style="width:100%; border-collapse:collapse; font-size:13.5px; min-width:440px;">
      <thead>
        <tr>
          <th style="text-align:left; padding:11px 14px; background:#FAF3F5; color:#6B5A60; font-weight:500; border-bottom:1px solid #EBDCE0;">수탁업체</th>
          <th style="text-align:left; padding:11px 14px; background:#FAF3F5; color:#6B5A60; font-weight:500; border-bottom:1px solid #EBDCE0;">위탁 업무의 내용</th>
        </tr>
      </thead>
      <tbody>
  ...
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(2) 회사는 위탁계약 체결 시 「개인정보 보호법」 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적·관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리·감독, 손해배상 등 책임에 관한 사항을 계약서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(3) 회사가 파견하는 매니저는 회사의 지휘·감독을 받는 개인정보 취급자이며, 별도의 수탁자가 아닙니다. 회사는 매니저에 대하여 개인정보 보호 교육을 실시하고 비밀유지 의무를 부과합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(4) 위탁업무의 내용이나 수탁자가 변경되는 경우에는 지체 없이 본 방침을 통하여 공개합니다.</p>

  <h2 style="font-family:'Noto Serif KR',serif; font-size:17px; font-weight:600; margin:40px 0 12px; padding-top:28px; border-top:1px solid #EBDCE0;">9. 개인정보의 파기절차 및 파기방법</h2>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 14px;">회사는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체 없이 해당 개인정보를 파기합니다.</p>
  <h3 style="font-size:14px; font-weight:500; color:#A9647E; margin:16px 0 6px;">(1) 파기 절차</h3>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">① 보유기간이 경과하거나 처리목적이 달성되었음에도 다른 법령에 따라 계속 보존하여야 하는 경우에는, 해당 개인정보를 별도의 데이터베이스로 옮기거나 보관장소를 달리하여 보존합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">② 별도 보관된 개인정보는 법률에 의한 경우를 제외하고 다른 목적으로 이용되지 아니합니다.</p>
  <h3 style="font-size:14px; font-weight:500; color:#A9647E; margin:16px 0 6px;">(2) 파기 방법</h3>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">① 전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">② 종이에 출력된 개인정보(현장 접수 장부, 인계확인서 사본 등)는 분쇄기로 분쇄하거나 소각하여 파기합니다.</p>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">③ 촬영 영상은 저장 매체에서 복구가 불가능한 방법으로 삭제합니다.</p>
  ...
  <h2 style="font-family:'Noto Serif KR',serif; font-size:17px; font-weight:600; margin:40px 0 12px; padding-top:28px; border-top:1px solid #EBDCE0;">14. 정보주체의 권익침해에 대한 구제방법</h2>
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 14px;">(1) 정보주체는 개인정보 침해로 인한 구제를 받기 위하여 아래 기관에 분쟁해결이나 상담 등을 신청할 수 있습니다.</p>
  <div style="overflow-x:auto; margin:0 0 14px;">
    <table style="width:100%; border-collapse:collapse; font-size:13.5px; min-width:440px;">
      <thead>
        <tr>
          <th style="text-align:left; padding:11px 14px; background:#FAF3F5; color:#6B5A60; font-weight:500; border-bottom:1px solid #EBDCE0;">기관</th>
          <th style="text-align:left; padding:11px 14px; background:#FAF3F5; color:#6B5A60; font-weight:500; border-bottom:1px solid #EBDCE0;">전화</th>
          <th style="text-align:left; padding:11px 14px; background:#FAF3F5; color:#6B5A60; font-weight:500; border-bottom:1px solid #EBDCE0;">홈페이지</th>
        </tr>
      </thead>
      <tbody>
  ...
  <p style="font-size:14.5px; line-height:1.95; color:#4A3B41; margin:0 0 8px;">(2) 「개인정보 보호법」 제35조(개인정보의 열람), 제36조(개인정보의 정정·삭제), 제37조(개인정보의 처리정지 등)의 규정에 의한 요구에 대하여 공공기관의 장이 행한 처분 또는 부작위로 인하여 권리 또는 이익의 침해를 받은 자는 행정심판법이 정하는 바에 따라 행정심판을 청구할 수 있습니다.</p>
